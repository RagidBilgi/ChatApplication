<?php
/*
 A class that runs the client side for the chat application.
*/

// namespace is for organizing code into logical groups and to prevent name collisions that can occur especially when your code base includes multiple libraries.
namespace MyApp; 

// Using Ratchet Interfaces.
use Ratchet\MessageComponentInterface;
use Ratchet\ConnectionInterface;

// dirname for returning the directory name of a given path.
...
class Chat implements MessageComponentInterface { // Implementing a Ratchet interface to build a Ratchet application with.
    protected $clients;
